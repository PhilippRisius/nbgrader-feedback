...
clean-docs: ## remove docs artifacts
	rm -f docs/apidoc/nbgrader_feedback*.rst
...
lint: ## check style
	...
	python -m numpydoc lint src/nbgrader_feedback/**.py
...
coverage: ## check code coverage quickly with the default Python
	python -m coverage run --source src/nbgrader_feedback -m pytest
...
autodoc: clean-docs ## create sphinx-apidoc files:
	sphinx-apidoc -o docs/apidoc --private --module-first src/nbgrader_feedback
